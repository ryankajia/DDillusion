...
% test degree illusion in  1 location across the visual field with
...
save(fileName,'RespMat','orientation','stimulusTime','gaborSpeedFrame','InternalDriftCyclesPerSecond','gaborDistanceFromFixationDegree','gaborDimPix','viewingDistance','trialNumber');
