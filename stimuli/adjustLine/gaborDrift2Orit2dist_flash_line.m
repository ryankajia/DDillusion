...
%             Screen('Flip',window);
    ...
    save(fileName,'RespMat',',meanSubIlluDegree','intervalTimesVector','cueShowTime','barDelayTime','cueVerDisDegree','gabor','viewingDistance','trialNumber','blockNumber','lineAngleAll','responseTimeVector');
